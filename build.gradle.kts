...
abstract class AzureLoginTask @Inject constructor(
    ...
    fun authenticate() {
        ...
        val clientId = System.getenv("ARM_CLIENT_ID") 
            ?: throw GradleException("ARM_CLIENT_ID is missing.")
        val clientSecret = System.getenv("ARM_CLIENT_SECRET") 
            ?: throw GradleException("ARM_CLIENT_SECRET is missing.")
        val tenantId = System.getenv("ARM_TENANT_ID") 
            ?: throw GradleException("ARM_TENANT_ID is missing.")
        ...
        execOps.exec {
            commandLine(
                azCommand, "login", "--service-principal",
                "-u", clientId,
                "-p", clientSecret,
                "--tenant", tenantId
            )
